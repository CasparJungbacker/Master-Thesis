...
\acrshort{dales} uses five prognostic variables to define the state of the atmosphere: three velocity components $u$, $v$ and $w$, the liquid water potential temperature $\theta_l$ and the total water specific humidity $q_t$. The general form of \Autoref{eq:ns_momentum} for the atmosphere is given by \citep{stullIntroductionBoundaryLayer1988}:
